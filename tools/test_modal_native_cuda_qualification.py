...
def valid_record() -> dict[str, Any]:
    ...
    record = {
        ...
        "status": "passed",
        "outcome": {
            "registered_cell_id": "t4-tiny-en-jfk-qualification-v4",
        ...
        "qualification_registration": {
            "manifest_id": "native-cuda-qualification-v4",
        ...
        "worker": {
            "campaign_id": "native-cuda-qualification-v4",
            "worker_id": WORKER_ID,
            "worker_ordinal": 0,
...
class NativeCudaQualificationContractTests(unittest.TestCase):
    ...
    def test_registered_decode_options_are_closed_and_executable(self) -> None:
        ...
        self.assertTrue(
            any("registered decode configuration" in failure for failure in failures),
            failures,
        )
    ...
    def test_registration_fields_and_manifest_cell_are_bound(self) -> None:
        ...
        record = valid_record()
        record["worker"]["campaign_id"] = "another-campaign"
        self.assert_rejected(record, "worker.campaign_id")
    ...
    def test_fault_trigger_and_blocked_attempt_are_derived(self) -> None:
        ...
        event["backend_call_relation"] = "after-backend-call"
        self.assert_rejected(record, "record.events.")
